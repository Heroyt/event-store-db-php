...
use EventStoreDb\Exceptions\Logic\CannotCombineFiltersException;
use EventStoreDb\Streams;
...
class ReadQuery
{
    ...
    public function send(): ReadResult {
        ...
        /** @var ReadResult<E> $result */
        $result = new ReadResult($response, $this->streams->serializer);
        return $result;
    }
